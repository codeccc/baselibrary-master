...
package com.wb.base.widget.viewpager;
...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int indicatorColor = 0x1Affffff;
    ...
    {
        this.indicatorColor = ContextCompat.getColor(mContext, resId);
    ...
    {
        this.underlineColor = ContextCompat.getColor(mContext, resId);
        invalidate();
    }
    ...
    {
        this.dividerColor = ContextCompat.getColor(mContext, resId);
        invalidate();
    }
    ...
    {
        this.tabTextColor = ContextCompat.getColor(mContext, resId);
        updateTabStyles();
    }
    ...
    {
        this.selectedTabTextColor = ContextCompat.getColor(mContext, resId);
        updateTabStyles();
    }
