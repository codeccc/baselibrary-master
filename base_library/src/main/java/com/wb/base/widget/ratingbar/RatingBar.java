package com.wb.base.widget.ratingbar;
...
/**
 * Time: 2016/12/16 14:26
 * Instruction: 可以自定义背景颜色大小的RatingBar
 */
public class RatingBar extends LinearLayout {
    ...
    public RatingBar(Context context, AttributeSet attrs) {
        ...
        starImageSize = mTypedArray.getDimension(R.styleable.RatingBar_starImageSize, 90);
        starImageWidth = mTypedArray.getDimension(R.styleable.RatingBar_starImageWidth, 50);
        starImageHeight = mTypedArray.getDimension(R.styleable.RatingBar_starImageHeight,  90);
